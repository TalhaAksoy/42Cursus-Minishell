...
NAME	=	minishell
CC		=	gcc -ggdb
SRCS	=	main.c allocate_files.c cmd_utils.c execute_utils.c execute.c heredoc.c redirection.c signal.c build_redirection.c utils_list_del_list.c utils_list_del_structs.c utils_list_new.c utils_tree_new.c utils_cleaning.c utils.c  utils2.c build_redirection2.c
